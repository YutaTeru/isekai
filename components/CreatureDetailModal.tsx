...
const CreatureDetailModal: React.FC<CreatureDetailModalProps> = ({ creature, onClose, isFavorite, onToggleFavorite, userName }) => {
                    ...
                    <div className="flex-1 space-y-4 pb-4 pt-2">
                        {chatHistory.map((msg) => (
                            <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                                ...
                                <div className={`max-w-[80%] p-4 rounded-2xl text-sm font-bold leading-relaxed whitespace-pre-wrap shadow-sm ${
                                    msg.sender === 'user' 
